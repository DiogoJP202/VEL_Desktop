...
export default function MenuLateral({ pagina }) {
  ...
  const mainLinks = [
    { key: "Dashboard", label: "Dashboard", icon: iconeDashboard, path: "/dashboard", iconAlt: "Icone de dashboard" },
    { key: "Pagamentos", label: "Pagamentos", icon: iconePagamentos, path: "/pagamentos", iconAlt: "Icone de pagamentos" },
    { key: "Entregadores", label: "Entregadores", icon: iconeEntregadores, path: "/entregadores", iconAlt: "Icone de entregadores" },
    { key: "Faturamento", label: "Faturamento", icon: iconeFaturamento, path: "/faturamento", iconAlt: "Icone de faturamento" },
    { key: "Contrato", label: "Contrato", icon: iconeContrato, path: "/contratoempregador", iconAlt: "Icone de contrato" },
    { key: "Coordenadores", label: "Coordenadores", icon: iconeCoordenadores, path: "/coordenador", iconAlt: "Icone de coordenadores" },
  ];
  ...
  useEffect(() => {
    ...
    async function loadCompanyInfo() {
      ...
      try {
        ...
        const fallbackCnpj = role === AUTH_ROLE.OWNER ? formatCnpj(String(userId)) : "";
        setCompanyInfo({
          name: "Empresa",
          subtitle: roleLabel,
          cnpj: fallbackCnpj,
          cnpjRaw: role === AUTH_ROLE.OWNER ? String(userId || "") : "",
          loading: false,
        });
      }
    }
